...
def run(cfg: ModulusConfig) -> None:
    cfg.network_dir = "./brain_param_kp_dose_time.lambda_1_100_50.heaviside_source_plus"
    ...
    inference_doses = [0.0, 2.0, 8.0, 16.0]
    ...
    for dose_value in inference_doses:
        ...
        for kp_value in inference_kps:
            ...
            for time_value in inference_times:
                ...
                domain.add_inferencer(interior_inferencer,
