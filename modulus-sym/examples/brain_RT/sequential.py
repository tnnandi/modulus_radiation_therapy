        ...
        if self.cfg.run_mode == "train":
            ...
            for domain_index in range(self.domain_index, len(self.domains)):
                ...
                for iteration_index in range(
                    ...
                    # add another argument to pass information about whether the time window corresponds to the IC or later steps (will use different max_steps)
                    self._train_loop(domain_index, sigterm_handler)
